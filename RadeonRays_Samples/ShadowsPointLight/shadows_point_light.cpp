...
int main(int argc, char* argv[])
{
    ...
    CLWProgram program = CLWProgram::CreateFromFile("shadows_point_light.cl", options.c_str(), context);
    ...
    SaveImage("shadows_point_light.jpg", image_data.get(), w, h);
}
